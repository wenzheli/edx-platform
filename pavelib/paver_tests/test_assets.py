...
class TestPaverAssetTasks(PaverTestCase):
    ...
    def test_compile_sass(self, options):
        ...
        if "lms" in system:
            ...
            expected_messages.append(
                u'rtlcss lms/static/css/mobile/main.css lms/static/css/mobile/main-rtl.css'
            )
            expected_messages.append(
...
class TestPaverThemeAssetTasks(PaverTestCase):
    ...
    def test_compile_theme_sass(self, options):
        ...
        if 'lms' in system:
            ...
            expected_messages.append(
                u'rtlcss {test_theme_dir}/lms/static/css/mobile/main.css'
                u' {test_theme_dir}/lms/static/css/mobile/main-rtl.css'.format(
                    test_theme_dir=str(TEST_THEME_DIR),
                )
            )
            expected_messages.append(
