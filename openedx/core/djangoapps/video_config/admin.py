...
from openedx.core.djangoapps.video_config.forms import (
    CourseHLSPlaybackFlagAdminForm, CourseVideoTranscriptFlagAdminForm, CourseVideoUploadsEnabledByDefaultAdminForm
)
from openedx.core.djangoapps.video_config.models import (
    ...
    VideoUploadsEnabledByDefault, CourseVideoUploadsEnabledByDefault,
)
